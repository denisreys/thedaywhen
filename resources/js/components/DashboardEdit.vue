<template>
    <div class="px-5 pt-4 pb-7 w-[100% + 0px)] ml-[-20px] mr-[-20px] sm:mx-0 bg-mylightgray">
        <div class="relative">
            <div class="day__title mb-4">{{ data.title }}</div>  
        ...
        <div class="">
            ...
            <div
                ...
                :class="{'placeholder': data.text.length == 0}" v-once v-html="'<div>'+data.text+'</div>'">
...
<script setup>
    ...
    let props = defineProps(['selectDay']);
